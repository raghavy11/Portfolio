...
const Projects = () => {
  return (
    <section id="projects" className="container mx-auto px-4 py-20 scroll-mt-24">
      <div className="text-center mb-12">
        ...
        >
          <h2 className="text-3xl font-bold mb-4">
            Featured{" "}
            <span className="text-yellow-400 dark:text-yellow-500">Projects</span>
          </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project, index) => (
          ...
          >
            <Card className="group overflow-hidden bg-neutral-900 border border-neutral-700 hover:shadow-xl transition-all duration-300">
